...
export let actormap = {
    ...
    "ST Strength":     "system.abilities.str.save.value",
    "Check Box 11":    "system.abilities.str.proficient",
    "ST Dexterity":    "system.abilities.dex.save.value",
    "Check Box 18":    "system.abilities.dex.proficient",
    "ST Constitution": "system.abilities.con.save.value",
    "Check Box 19":    "system.abilities.con.proficient",
    "ST Intelligence": "system.abilities.int.save.value",
    "Check Box 20":    "system.abilities.int.proficient",
    "ST Wisdom":       "system.abilities.wis.save.value",
    "Check Box 21":    "system.abilities.wis.proficient",
    "ST Charisma":     "system.abilities.cha.save.value",
